    ...
    const questions = [
      {
        ...
        validate: function (value) {
          ...
          return isNaN(value) || value < 0
            ? 'Please enter positive numeric value only'
            : true;
        },
      },
    ];
      ...
      return {
        ...
        validate: function (value) {
          ...
          if (isNaN(args[1]) || args[1] < 0)
            return 'Please enter positive numeric value only for weight';
          if (isNaN(args[2]) || args[2] < 0)
            return 'Please enter positive numeric value only for distance';
          return true;
        },
      };
    });
